export class Constants {
    ...
    public static REEL_NUM: number = 5;
    ...
    public static RESIZE_OFFSET_WIDTH: number = 350;
    public static RESIZE_OFFSET_HEIGHT: number = 300;

    public static SYMBOL_HEIGHT_WIDTH: number = 180;
}